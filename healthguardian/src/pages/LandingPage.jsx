  ...
  return (
    <div className="bg-[#f8f9ff] text-[#0b1c30] dark:bg-slate-950 dark:text-slate-100">
      ...
      <main className="pt-16 md:pt-20">
        ...
        <section className={`${sectionClass} bg-white dark:bg-slate-950`} id="emergency">
          <div className="mx-auto grid max-w-7xl gap-8 lg:grid-cols-[0.9fr_1.1fr] lg:items-start">
            <div className="rounded-[2rem] border border-red-200 bg-red-50 p-6 shadow-xl shadow-red-900/5 sm:p-8 dark:border-red-900/70 dark:bg-red-950/30">
              ...
              <h2 className="mb-3 text-3xl font-bold text-red-950 dark:text-red-100">Find critical patient details fast</h2>
              <p className="mb-6 text-sm leading-relaxed text-red-900/75 dark:text-red-100/75">
            ...
            <div className="rounded-[2rem] border border-slate-200 bg-[#f8f9ff] p-5 shadow-sm sm:p-6 dark:border-slate-800 dark:bg-slate-900">
              {emergencyProfile ? (
                <div className="space-y-5">
                  <div className="flex flex-col gap-4 border-b border-slate-200 pb-5 sm:flex-row sm:items-start sm:justify-between dark:border-slate-800">
                    <div>
                      ...
                      <h3 className="text-2xl font-bold text-slate-950 dark:text-white">{emergencyProfile.fullName}</h3>
                    ...
                    <div className="grid grid-cols-2 gap-3 sm:min-w-52">
                      <div className="rounded-2xl bg-white p-3 text-center dark:bg-slate-950">
                ...
                <div className="flex min-h-[26rem] flex-col items-center justify-center rounded-[1.5rem] border border-dashed border-slate-300 p-8 text-center dark:border-slate-700">
                  <div className="mb-4 flex h-16 w-16 items-center justify-center rounded-2xl bg-red-100 text-3xl text-red-600 dark:bg-red-900/50">!</div>
                  <h3 className="text-xl font-bold text-slate-950 dark:text-white">Emergency profile preview</h3>
